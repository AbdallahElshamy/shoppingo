...
<!-- Product Details -->
    ...
    <div class = "card-wrapper">
        ...
        <div class = "product-imgs">
            <div class = "img-display">
                <div class = "img-showcase">
                    <img src = "image/images/product_07.jpeg" alt = "shoe image">
                </div>
            </div>
        </div>
        <!-- card right -->
        <div class = "product-content">
            <h2 class = "product-title">T-Shirt For Men</h2>
        ...
        <div class = "product-price">
            <p class = "last-price">Old Price: <span>300 L.E</span></p>
            <p class = "new-price">New Price: <span>199.99 L.E</span></p>
        </div>
