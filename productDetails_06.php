...
<!-- Product Details -->
    ...
    <div class = "card-wrapper">
        ...
        <div class = "product-imgs">
            <div class = "img-display">
                <div class = "img-showcase">
                    <img src = "image/images/product_18.jfif" alt = "">
                </div>
            </div>
        </div>
        <!-- card right -->
        <div class = "product-content">
            <h2 class = "product-title">Suit For Men</h2>
        ...
        <div class = "product-price">
            <p class = "last-price">Old Price: <span>3000 L.E</span></p>
            <p class = "new-price">New Price: <span>2249.99 L.E</span></p>
        </div>
