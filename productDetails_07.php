...
<!-- Product Details -->
    ...
    <div class = "card-wrapper">
        ...
        <div class = "product-imgs">
            <div class = "img-display">
                <div class = "img-showcase">
                    <img src = "image/images/product_23.jfif" alt = "">
                </div>
            </div>
        </div>
        <!-- card right -->
        <div class = "product-content">
            <h2 class = "product-title">Blazer For Men</h2>
        ...
        <div class = "product-price">
            <p class = "last-price">Old Price: <span>500 L.E</span></p>
            <p class = "new-price">New Price: <span>449.99 L.E</span></p>
        </div>
